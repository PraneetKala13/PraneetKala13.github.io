                ...
                return (
                  ...
                  >
                    ...
                    <CardContent className="p-6">
                      ...
                      <p className="text-sm text-[#A68868] mb-2 font-medium">{project.category} • {project.period}</p>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {project.technologies.map((tech) => (
                          <span
                            key={tech}
                            className="px-2 py-1 bg-[#4B6382] text-white rounded text-xs font-medium"
                          >
                            {tech}
                          </span>
                        ))}
